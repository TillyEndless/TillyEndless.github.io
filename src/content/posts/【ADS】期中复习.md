...
* 势能函数：**Φ(Heap)=number of heavy node in Heap**
  ...
  摊还证明：![[截屏2024-11-05 22.10.20.png]](/media/3.png)![[截屏2024-11-05 22.18.49.png]](/media/4.png)![[截屏2024-11-05 22.19.21.png]](/media/5.png)
...
三类方法：代换法、递归树法、主方法
#### 主方法形式三
考试一般会用到的是主方法第三种形式：![[截屏2024-11-05 22.28.18.png]](/media/6.png)

#### 其他形式&方法的理解
* 代换法：先猜后证，证明时用放缩方法。
* 递归树法：等比数列求和；画出图![[截屏2024-11-05 23.03.14.png]](/media/7.png)
	* 可能需要运用数学工具：![[截屏2024-11-05 23.04.28.png]](/media/8.png)（巧记：最上面和最下面换一下）
* 主方法形式一（有人能记住吗）![[截屏2024-11-05 23.11.11.png]](/media/9.png)
* 主方法形式二![[截屏2024-11-05 23.11.29.png]](/media/10.png)
